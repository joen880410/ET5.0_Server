...
namespace ETModel
{
    ...
    public class AppManagerComponent: Component
	{
		...
		public void Awake()
		{
			...
			{
				Game.Scene.GetComponent<TimerComponent>().WaitForMilliSecondAsync(100);
            ...
            currentProcess.Exited += new EventHandler(OnProcessExited);
        }
		...
		private async ETVoid WatchProcessAsync()
		{
			...
			while (true)
			{
				await Game.Scene.GetComponent<TimerComponent>().WaitForMilliSecondAsync(5000);
