    ...
    internal static class Program
	{
		...
		private static void Main(string[] args)
		{
			...
			try
			{
				...
				const long pingWaitTime = 5 * 1000;
				const long pingOvertime = 60 * 60 * 1000;
				...
				switch (startConfig.AppType)
				{
					case AppType.Master:
						...
						Game.Scene.AddComponent<ScheduleComponent>();
					...
					case AppType.DB:
						...
						Game.Scene.AddComponent<DBViewComponent>();
						...
						Game.Scene.AddComponent<RewardCodeComponent>();
						break;
					case AppType.Realm:
						Game.Scene.AddComponent<NetInnerComponent, string>(innerConfig.Address);
						Game.Scene.AddComponent<NetOuterComponent, string>(outerConfig.Address);
                        ...
                        Game.Scene.AddComponent<PingComponent, long, long>(pingWaitTime, pingOvertime);
					...
					case AppType.Lobby:
						...
						Game.Scene.AddComponent<ProfileComponent>();
						Game.Scene.AddComponent<ConsoleComponent>();
						Game.Scene.AddComponent<CloudStorageComponent>();
						// 設備組件
						Game.Scene.AddComponent<DeviceComponent>();
					...
					case AppType.AllServer:
						...
						Game.Scene.AddComponent<DeviceComponent>();
						//Swagger 
						//Game.Scene.GetComponent<NetOuterComponent>().Create(NetworkProtocol.WebSocket, "http://*:8888/");
						break;
