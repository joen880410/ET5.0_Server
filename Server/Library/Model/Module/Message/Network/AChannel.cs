...
namespace ETModel
{
	...
	public abstract class AChannel : ComponentWithId
	{
		...
		public static event Action<long, long> OnIncreaseSendedPackInfo;

		public static event Action<long, long> OnIncreaseReceivedPackInfo;
		...
		protected static void IncreaseSendedPackSize(long size, long count)
        {
			OnIncreaseSendedPackInfo?.Invoke(size, count);
		}

		protected static void IncreaseReceivedPackSize(long size, long count)
        {
			OnIncreaseReceivedPackInfo?.Invoke(size, count);
		}
