...
namespace ETModel
{
	public static class ComponentFactory
	{
		...
		public static Component CreateWithParent<A>(Type type, A a, Component parent, bool fromPool = true)
		{
			Component component;
			if (fromPool)
			{
        ...
        public static Component CreateWithId(Type type, long id, bool fromPool = true)
        {
            Component component;
            if (fromPool)
            {
